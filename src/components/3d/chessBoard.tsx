    ...
    const boardElements = useMemo(() => {
        return board.map((rowArr, row) =>
            rowArr.map((piece, col) => {
                ...
                const squareKey = getSquare(row, col);
                ...
                return (
                    // biome-ignore lint/a11y/noStaticElementInteractions: three.js interactive group
                    <group key={squareKey} onClick={() => handleSquareClick(row, col)}>
                            ...
                            <group>
                                <Suspense fallback={null}>
                                    {lastMove?.to === squareKey ? (
                                        ...
                                        <group position={squareToPosition(squareKey)}>
                                            <PieceComponent piece={piece} highlight={highlight} />
                                        </group>
                                    )}
                                </Suspense>
